    ...
    <Section className="py-[32px] md:py-[64px] lg:py-[96px] xl:py-[135px] 2xl:py-[150px]">
      <div className="grid">
        <div className="grid place-content-center place-items-center max-w-[736px] text-center mx-auto">
          <GradientHeading className="mb-6 text-[36px] md:text-[48px] lg:text-[60px]">
            {title}
          </GradientHeading>
          ...
          <div className="flex gap-4 items-center">
            <Link id="#contact" className={buttonVariants({ variant: "destructive", size: "lg" })} href="#contact" target="_blank">
              Contact me
            </Link>
